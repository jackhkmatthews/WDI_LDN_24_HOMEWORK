...
class PlanetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create planet" do
    assert_difference('Planet.count') do
      post planets_url, params: { planet: { distance_from_sun: @planet.distance_from_sun, life: @planet.life, mass: @planet.mass, name: @planet.name, rings: @planet.rings } }
    end
  ...
  test "should update planet" do
    patch planet_url(@planet), params: { planet: { distance_from_sun: @planet.distance_from_sun, life: @planet.life, mass: @planet.mass, name: @planet.name, rings: @planet.rings } }
